...
public class GreyImageTest extends TestCase {
	...
	private static int[][] beforeCallToProcessImage = { { 221, 184, 178, 84, 135 }, { 84, 255, 255, 130, 84 }, { 78, 255, 0, 0, 78 }, { 84, 130, 255, 130, 84 } };

	private static int[][] afterCallToProcessImage = { { 221, 184, 100, 84, 135 }, { 0, 125, 171, 130, 84 }, { 78, 255, 0, 0, 78 }, { 84, 130, 255, 130, 84 } };

	/* Implement a method that compares two 2D arrays */

	public void testEqualityOfTwo2DArrays() throws Exception {
		assertEquals(true, GreyImage.areSame(afterCallToProcessImage, afterCallToProcessImage));
		assertEquals(false, GreyImage.areSame(GreyImage.createTestArray(), afterCallToProcessImage));
	}
	...
	public void testPartB() throws Exception {
		...
		// assert
		assertTrue(GreyImage.areSame(afterCallToProcessImage, greyImage.getPixelValues()));

		// Assert.assertArrayEquals(afterCallToProcessImage, greyImage.getPixelValues());
	}
}
